    ...
    def __init__(self):
        ...
        self.nd = self.addGen(
            Wire(
                ...
                clg=UncoloredCenterLineGrid(
                    pitch=ndPitch, width=ndWidth, repeat=2 * self.m2PerUnitCell
                ),
        ...
        self.m1 = self.addGen(
            Wire(
                ...
                spg=EnclosureGrid(
                    pitch=unitCellHeight, stoppoint=unitCellHeight // 2 - m2Pitch
                ),
            )
        )
        ...
        self.pl = self.addGen(
            Wire(
                ...
                "v",
                clg=UncoloredCenterLineGrid(
                    width=plWidth, pitch=plPitch, offset=plOffset, repeat=2
                ),
