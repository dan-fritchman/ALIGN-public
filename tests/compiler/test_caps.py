...
from align.compiler.compiler import (
    compiler_input,
...
def test_cap():
    ...
    assert all_primitive_names == {
        "CAP_2T_68022297",
        "CAP_2T_90203361",
        "NMOS_4T_125789",
    }
    assert primitives.find("CAP_2T_68022297").elements[0].parameters == {
        "VALUE": "3E-14",
        "PARALLEL": "1",
        "STACK": "1",
    }
    assert primitives.find("CAP_2T_90203361").elements[0].parameters == {
        "VALUE": "6E-14",
        "PARALLEL": "1",
        "STACK": "1",
    }
    ...
    all_uniq_inst = set(
        [e.name for i in primitives if isinstance(i, SubCircuit) for e in i.elements]
    )
