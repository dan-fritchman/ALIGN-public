...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Utility to create test case for router"
    )
    parser.add_argument(
        "--input_path", type=pathlib.Path, help="Path to the input json file"
    )
    parser.add_argument(
        "--output_path", type=pathlib.Path, help="Path to the output json file"
    )
    parser.add_argument(
        "--nets", type=str, help="comma separated list of net names to keep"
    )
    parser.add_argument(
        "--layers", type=str, help="comma separated list of layers to keep"
    )
