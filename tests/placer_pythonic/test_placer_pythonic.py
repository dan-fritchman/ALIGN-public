...
from align.pnr.placer_pythonic import (
    pythonic_placer,
    propagate_down_global_signals,
    trim_placement_data,
)
...
def ring_oscillator():
    ...
    data = {
                ...
                "terminals": [
                    {
                        "layer": "M1",
                        "netName": "D",
                        "rect": [2000, 1000, 2500, 11000],
                        "netType": "pin",
                    },
                    {
                        "layer": "M1",
                        "netName": "G",
                        "rect": [3000, 1000, 3500, 11000],
                        "netType": "pin",
                    },
                    {
                        "layer": "M1",
                        "netName": "S",
                        "rect": [4000, 1000, 4500, 110000],
                        "netType": "pin",
                    },
                ],
                ...
                "terminals": [
                    {
                        "layer": "M2",
                        "netName": "D",
                        "rect": [1000, 1000, 9000, 1500],
                        "netType": "pin",
                    },
                    {
                        "layer": "M2",
                        "netName": "G",
                        "rect": [1000, 3000, 9000, 3500],
                        "netType": "pin",
                    },
                    {
                        "layer": "M2",
                        "netName": "S",
                        "rect": [1000, 5000, 9000, 5500],
                        "netType": "pin",
                    },
                ],
                "constraints": place_on_grid,
                ...
                "terminals": [
                    {
                        "layer": "M1",
                        "netName": "D",
                        "rect": [2000, 1000, 2500, 10000],
                        "netType": "pin",
                    },
                    {
                        "layer": "M1",
                        "netName": "G",
                        "rect": [3000, 1000, 3500, 10000],
                        "netType": "pin",
                    },
                    {
                        "layer": "M1",
                        "netName": "S",
                        "rect": [4000, 1000, 4500, 10000],
                        "netType": "pin",
                    },
                ],
                "constraints": place_on_grid,
        ...
        "modules": [
            ...
            },
            {
                ...
                "instances": [
                    {
                        "instance_name": "XI1",
                        "abstract_template_name": "ring_oscillator_stage",
                        "fa_map": [
                            {"formal": "VCC", "actual": "VCCX"},
                            {"formal": "VSSX", "actual": "VSSX"},
                            {"formal": "VI", "actual": "VO"},
                            {"formal": "VO", "actual": "V1"},
                        ],
                    },
        ...
        "global_signals": [
            {"prefix": "global_power", "formal": "supply0", "actual": "VSSX"},
            {"prefix": "global_power", "formal": "supply1", "actual": "VCCX"},
        ],
    }
    return data
    ...
    modules["ring_oscillator_stage"]["constraints"].append(
        {
            ...
            "instances": [
                i["instance_name"]
                for i in modules["ring_oscillator_stage"]["instances"]
            ],
        }
    )
    placement_data = pythonic_placer(
        "ring_oscillator_stage", input_data, scale_factor=10
    )
    draw_placement(placement_data, "ring_oscillator_stage_0")
