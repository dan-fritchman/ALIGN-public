...
parser.add_argument("-n", "--nm", type=str, help="Name of LEF file to convert")
...
new_layout_d = lef_to_json.lef_txt_to_layout_d(
    lef_txt, nm, scale_factor=scale_factor, m1pitch=m1pitch, m2pitch=m2pitch
)
