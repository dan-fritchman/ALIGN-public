...
class BlocksParser(Parser):
    ...
    def whole(self):
        ...
        while True:
            if self._accept("EOLN"):
                ...
                for i in range(n):
                    ...
                    pin_lst.append(
                        {"pin": pin_name, "layer": layer, "points": point_lst}
                    )
                    self._expect("EOLN")
                obs_lst = []
                ...
                b.blocks.append(
                    {"block": block_nm, "pins": pin_lst, "obstructions": obs_lst}
                )
        ...
        return {"blocks": b.blocks, "terminals": b.terminals}
    ...
    def whole(self):
        ...
        while True:
            if self._accept("EOLN"):
                ...
                raise SyntaxError(
                    "Expected SymmNet, CritNet, ShieldNet, or MatchBlock keyword."
                )
        return {
            "symmnets": b.symmnets,
            "critnets": b.critnets,
            "shieldnets": b.shieldnets,
            "matchblocks": b.matchblocks,
        }
