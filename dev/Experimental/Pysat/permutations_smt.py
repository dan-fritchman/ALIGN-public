    ...
    def abut(self, u, v, axis="H"):
        def abut_aux(u, v):
            ...
            for i in range(self.n):
                ...
                self.solver.add(
                    z3.Or(
                        z3.Not(uv_order_expr),
                        z3.Not(ui_order_expr),
                        z3.Not(iv_order_expr),
                    )
                )
    ...
    def symmetric(self, lst_of_lst, axis="V"):
        ...
        def aux0(l, u, x, v):
            self.solver.add(
                z3.Or(
                    z3.Not(l),
                    z3.Not(self.order_expr(u, x, axis=oa)),
                    self.order_expr(x, v, axis=oa),
                )
            )
            self.solver.add(
                z3.Or(
                    z3.Not(l),
                    z3.Not(self.order_expr(x, v, axis=oa)),
                    self.order_expr(u, x, axis=oa),
                )
            )
        ...
        def aux1(l0, l1, u0, v0, u1, v1):
            self.solver.add(
                z3.Or(
                    z3.Not(l0),
                    z3.Not(l1),
                    z3.Not(self.order_expr(u0, u1, axis=oa)),
            ...
            self.solver.add(
                z3.Or(
                    z3.Not(l0),
                    z3.Not(l1),
                    z3.Not(self.order_expr(u1, u0, axis=oa)),
    ...
    def gen_solutions(self, max_solutions=100):
        ...
        for i in range(max_solutions):
            ...
            self.solver.add(
                z3.Or(
                    z3.Not(control),
                    *[z3.Not(x) for x in self.gen_assumptions(p_res, n_res)],
                )
            )
