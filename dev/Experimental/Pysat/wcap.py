...
def main():
    ...
    new_leaves = [dp1x_interface, dp2x_interface, dp4x_interface, mirrors_interface]
    ...
    for y in range(b[1] + 1, b[3]):
        ...
        x1 = b[2] - 1
        metal2_kors.append(
            {"net_name": "!kor", "layer": "metal2", "rect": [x0, y, x1, y]}
        )
