            ...
            "terminals": [
                {
                    "net_name": "outa",
                    "layer": "metal3",
                    "rect": [31, 5 * cunit_height + 1, 31, 6 * cunit_height - 1],
                },
                {
                    "net_name": "outb",
                    "layer": "metal3",
                    "rect": [33, 5 * cunit_height + 1, 33, 6 * cunit_height - 1],
                },
            ],
        }
    )
    ...
    place["instances"].append(
        {
            ...
            "formal_actual_map": {"outa": "sda_outa", "outb": "sda_outb"},
        }
    )
