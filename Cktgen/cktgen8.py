...
if __name__ == "__main__":
    ...
    adnetl.addInstance(
        ADI(
            pdev,
            "up1",
            mirrorAcrossYAxis(pdev).preMult(ADITransform.translate(xg(1), yg(8))),
        )
    )
    ...
    adnetl.addInstance(
        ADI(
            pdev,
            "up2",
            mirrorAcrossYAxis(pdev).preMult(ADITransform.translate(xg(1), yg(5))),
        )
    )
    ...
    adnetl.addInstance(
        ADI(
            pdev,
            "up3",
            mirrorAcrossYAxis(pdev).preMult(ADITransform.translate(xg(4), yg(3))),
        )
    )
