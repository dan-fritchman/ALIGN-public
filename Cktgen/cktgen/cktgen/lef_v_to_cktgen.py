...
def get_placement_from_gds(top_module):
    ...
    hand_placements = [
        ...
        (
            "xM03|MN0_xM02|MN0_xM32|MN0_xM12|MN0_xM22|MN0",
            "CMB_4_n10_A1_B1_C2_D4",
            [252160, 1840],
            0,
            0,
        ),
...
def convert(lef_str, verilog_str, pl_str):
    ...
    for inst in top_module.instances:
        ...
        assert all(formal in lef_formals for (formal, actual) in inst.fa_list), (
            inst.fa_list,
            lef_formals,
        )
    ...
    for instance in d["instances"]:
        ...
        instance["transformation"] = {"oX": xy[0], "oY": xy[1], "sX": 1, "sY": 1}  # N
