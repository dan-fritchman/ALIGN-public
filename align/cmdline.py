...
class CmdlineParser:
    def __init__(self, *args, **kwargs):
        ...
        parser = argparse.ArgumentParser(
            *args, **kwargs, description="directory path for input circuits"
        )
        parser.add_argument("netlist_dir", type=str, help="Path to netlist directory")
        parser.add_argument(
            "-p",
            "--pdk_dir",
            type=str,
            ...
            default=None
            if align_home is None
            else align_home + "/pdks/FinFET14nm_Mock_PDK",
        ...
        parser.add_argument(
            "--skipGDS", action="store_true", help="Don't generate GDS files."
        )
        ...
        parser.add_argument(
            "--viewer", action="store_true", help="Start lightweight viewer."
        )
