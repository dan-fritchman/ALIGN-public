    ...
    with open(name, "rt") as ifile:
        for line in ifile:
            ...
            if isElement(tag_name):
                ...
                jsonName = tag_name.lower()

            if (tag_type != types.NODATA and tag_name[0:3] == "BGN") or isElement(
                tag_name
            ):
